...
export const Resume6_Data = {
    competencies:[
        ...
        {
            skill: "ipsum dolor sit amet",
            percentage: "92%"
        },
        {
            skill: "sit amet, consectetuer",
            percentage: "82%"
        },
        {
            skill: "amet. consectetuer",
            percentage: "90%"
        },
        {
            skill: "adipiscing elit. maecenas",
            percentage: "80%"
        },
    ],
    certifications: [
    ...
    extra: [
        ...
        "Integer non ipsum arcu. In hac habitasse platea dictumst. Fusce posuere dolor est, eget mollis orci tempus nec.",
        "Maecenas non mattis urna, sed tristique neque. Curabitur augue sapien.",
        "cursus vel iaculis sit ame.",
        "fermentum aliquet neque."
    ],
    social: [
        {
            image: phone,
            text: "+91 933-092-9083"
        },
        {
            image: message,
            text: "info@mycvdesigner.com"
        },
        {
            image: home,
